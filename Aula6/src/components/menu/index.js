    ...
    return (
        <View style={Styles.container}>
            <View style={Styles.headerContainer}>
                     <Icon name="navicon" style={Styles.iconeHeader} onPress={() => navigateToScreen('Hidden')}/>
                     <Image
                            source={Logo}
            ...
            <View style={Styles.screenContainer}>
                <View style={[Styles.screenStyle, (activeItemKey == 'Ajuda') ? Styles.activeBackgroundColor : null]}>
                ...
                <View style={[Styles.screenStyle, (activeItemKey == 'Sair') ? Styles.activeBackgroundColor : null]}>
                    <Icon name="power-off" style={Styles.icone} />
                    <Text style={[Styles.screenTextStyle, (activeItemKey == 'Sair') ? Styles.selectedTextStyle : null]} onPress={() => navigateToScreen('Sair')}>Sair</Text>
                </View>
