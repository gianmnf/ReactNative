    ...
    <View style={Styles.container}>
      ...
      <View style={Styles.screenContainer}>
        ...
        <View 
          style={[
           Styles.screenStyle,
           activeItemKey == 'AtualizarUsuario' ? Styles.activeBackgroundColor : null,
          ]}>
          <Icon name="cogs" style={Styles.icone} />
          <Text 
            style={[
              Styles.screenTextStyle,
               activeItemKey == 'AtualizarUsuario' ? Styles.selectedTextStyle : null,
            ]} 
            onPress={() => navigateToScreen('AtualizarUsuario')}>
            Atualizar Dados
          </Text>
        </View>
        <View
