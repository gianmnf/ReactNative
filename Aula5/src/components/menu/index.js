    ...
    <View style={Styles.container}>
      ...
      <View style={Styles.screenContainer}>
        ...
        <View
          style={[
            Styles.screenStyle,
            activeItemKey == 'Configuracoes' ? Styles.activeBackgroundColor : null,
          ]}>
          <Icon name="cogs" style={Styles.icone} />
          <Text
            style={[
              Styles.screenTextStyle,
              activeItemKey == 'Configuracoes' ? Styles.selectedTextStyle : null,
            ]}
            onPress={() => navigateToScreen('Configuracoes')}>
            Configurações
          </Text>
        </View>
        <View
